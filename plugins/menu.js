 ...
 *Powered By @${'6289516947204'.split('@')[0]}*`
    let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender
     let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg")
 ...
   "productImage":{ 
   "mimetype": "image/jpeg", 
   "jpegThumbnail": await (await fetch('https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg')).buffer(), //Gambarnye
     }, 
   "title": `${ucapan()}`, 
 ...
 const fload = {
    ...
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg')).buffer(), //Gambarnye
 ...
     }) 
     if (teks == '404') {
 	let cute = `${pickRandom(['https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg', 'https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg', 'https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg', 'https://https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg', 'https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg', 'https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg', 'https://telegra.ph/file/d1011c8e279a6bf8c62d8.jpg'])}` 
...
/*await conn.send2ButtonDoc(m.chat, '──────────[ *DASHBOARD* ]──────────', text, 'OWNER', '.owner', 'Rules', '.rules', m, { 
 ...
     contextInfo: { forwardingScore: 99999, isForwarded: true, 
         externalAdReply: { 
             title: 'bot Testing Project By iyan', 
             body: `${pickRandom(['udah makan belum kak?', 'udh mandi belum kak?', 'Semangat ya kak!', 'Jangan begadang mulu ya!', 'jangan spam ya kak!', 'Jangan lupa donasi yak kak! >.<', 'Jaga kesehatan yaw kak!', 'Jangan lupa makan!', 'Jangan lupa istirahat yak! >.<', 'I Love you kak >.< 💗✨', 'Pr nya udh belum kak?', 'Jangan kebanyakan main hp yk! nanti sakit :‹'])}`, 
             description: `${pickRandom(['udah makan belum kak?', 'udh mandi belum kak?', 'Semangat ya kak!', 'Jangan begadang mulu ya!', 'jangan spam ya kak!', 'Jangan lupa donasi yak kak! >.<', 'Jaga kesehatan yaw kak!', 'Jangan lupa makan!', 'Jangan lupa istirahat yak! >.<', 'I Love you kak >.< 💗✨', 'Pr nya udh belum kak?', 'Jangan kebanyakan main hp yk! nanti sakit :‹'])}`, 
             mediaType: 2, 
